    ...
    <div class="receipt">
        <div class="items">
            ...
            if (isset($_POST['confirm'])) {
                ...
                // Update the status to 'Cancelled' for the specified route_id
                $updateStatusQuery = "UPDATE history_1 SET status = 'Cancelled', cancel = 'confirmed' WHERE route_id = '$confirmedRouteId'";
